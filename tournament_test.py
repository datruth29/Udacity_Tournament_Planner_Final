...
def testStandingsBeforeMatches():
    deleteMatches()
    deletePlayers()
    registerPlayer(createPlayer("Melpomene Murray"), 1)
    registerPlayer(createPlayer("Randy Schwartz"), 1)
...
def testReportMatches():
    deleteMatches()
    deletePlayers()
    createPlayer("Bruno Walton")
    createPlayer("Boots O'Neal")
    createPlayer("Cathy Burton")
